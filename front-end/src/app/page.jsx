          ...
          <div className="col-md-8">
            <div className="card-body-home">
              ...
              <p className="card-text" id="textoSobre">
                ...
                organização. A solução une tecnologia e humanização, oferecendo
                mais conforto, autonomia e qualidade no atendimento.
              </p>
              <Link href={'/sobre'}>
  ...
  />
      ...
      <div className="text-center paiTexto">
        <p className="textoApresentandoMedicos">
          Conheça alguns médicos da Clínica Vida Plena, uma equipe comprometida
          em oferecer atendimento humanizado e de qualidade. Cada profissional
          trabalha com dedicação para cuidar da saúde e bem-estar da nossa
          comunidade.
        </p>
      </div>
