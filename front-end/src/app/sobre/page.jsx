...
export default function Sobre() {
  return (
    <>
        ...
        <div className="row d-flex align-items-center">
          <div className="col-md-6">
            ...
            <p className="texto-sobre">
              ...
              agenda hospitalar digital que permite aos médicos cadastrarem suas
              disponibilidades e aos pacientes agendarem consultas de forma
              prática e segura. Essa iniciativa torna o processo de marcação
              mais ágil, melhora a organização interna e reforça o compromisso
              da instituição com a qualidade no atendimento e o bem-estar de
              todos.
            </p>
            <p className="texto-sobre">
              ...
              proporcionar uma vida mais plena para todos. Com essa integração,
              promovemos mais conforto, autonomia e transparência no agendamento
              de consultas, fortalecendo o vínculo entre profissionais e
              pacientes e elevando a qualidade do atendimento prestado.{' '}
            </p>
          </div>
                ...
                <div className="accordion-item mb-3 border-0">
                  ...
                  >
                    <div className="accordion-body">
                      ...
                      em crescimento saudável, vacinação, prevenção e tratamento
                      de doenças comuns na infância. Cuidado humanizado para
                ...
                <div className="accordion-item mb-3 border-0">
                  ...
                  >
                    <div className="accordion-body">
                      ...
                      problemas na coluna e articulações. Atuamos com ortopedia
                      clínica e cirúrgica, reabilitação e fisioterapia para
                      restaurar sua mobilidade{' '}
                    </div>
                  </div>
                </div>
                ...
                <div className="accordion-item mb-3 border-0">
                  ...
                  >
                    <div className="accordion-body">
                      ...
                      procedimentos estéticos como botox, peelings e tratamentos
                      a laser.{' '}
                    </div>
                  </div>
                </div>
                <div className="accordion-item mb-3 border-0">
                  ...
                  >
                    <div className="accordion-body">
                      ...
                      AVC, epilepsia, Alzheimer, Parkinson e distúrbios do sono.
                      Avaliação especializada com foco em preservar a função
                      neurológica e o bem-estar.
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div className="container my-4">
              <div className="accordion" id="accordionExample">
                <div className="accordion-item mb-3 border-0">
                  ...
                  >
                    <div className="accordion-body">
                      ...
                      anticoncepção, pré-natal, menopausa, miomas, endometriose
                      e saúde hormonal. Atendimento em todas as fases da vida da
                      mulher.
                    </div>
                  </div>
                </div>
                ...
                <div className="accordion-item mb-3 border-0 ">
                  ...
                  >
                    <div className="accordion-body">
                      Tratamento de diabetes, obesidade, distúrbios da tireoide,
                      osteoporose e alterações hormonais. Acompanhamento para
                      regular o metabolismo e melhorar sua saúde e energia.{' '}
                    </div>
                  </div>
                </div>
                ...
                <div className="accordion-item mb-3 border-0">
                  ...
                  >
                    <div className="accordion-body">
                      Diagnóstico e tratamento de ansiedade, depressão, insônia,
                      transtorno bipolar, TDAH e outras condições emocionais.
                      Atendimento humanizado e sigiloso com foco no bem-estar
                      mental.{' '}
                    </div>
                  </div>
                </div>
                ...
                <div className="accordion-item mb-3 border-0">
                  ...
                  >
                    <div className="accordion-body">
                      ...
                      de doenças como miopia, catarata, glaucoma e conjuntivite.
                      Avaliações completas para todas as idades.
                    </div>
                  </div>
                </div>
      ...
      {/* Nossa misão */}
      <div className="container mx-auto px-4" style={{ marginBottom: '20px' }}>
        <div className="row">
          ...
          <div className="col-md-11">
            <p className="transformar-sobre" style={{}}>
              Transformar a gestão hospitalar por meio da tecnologia, otimizando
              o tempo de profissionais da saúde e oferecendo praticidade,
              organização e agilidade no cuidado com os pacientes.
            </p>
          </div>
        </div>
      </div>
        ...
        <div className="row">
          ...
          <div className="col-md-11">
            <p className="ser-sobre">
              ...
              hospitalar, promovendo uma experiência mais eficiente, integrada e
              humana para profissionais de saúde e pacientes.{' '}
            </p>
          </div>
        </div>
      </div>
        ...
        <div className="row">
          ...
          <div className="col-md-11">
            <p className="letras-sobre">
              {' '}
              <span className="lista-sobre">Eficiência –</span> Acreditamos que
              tempo é um recurso valioso na saúde. Trabalhamos para reduzir
            ...
            <p className="letras-sobre">
              {' '}
              <span className="lista-sobre">Humanização –</span> Valorizamos as
              pessoas por trás dos processos. Nosso foco é liberar tempo para
              que o cuidado com o paciente seja prioridade.
            </p>
            <p className="letras-sobre">
              {' '}
              ...
              <div className="card-body-custom-sobre">
                <div>
                  ...
                  <p className="card-text texto-poppins-sobre">
                    Gerencie consultas de forma simples e rápida, trazendo mais
                    organização para a clínica e conforto para os pacientes.
                  </p>
                </div>
              ...
              <div className="card-body-custom-sobre">
                <div>
                  ...
                  <p className="card-text texto-poppins-sobre">
                    ...
                    lugar, facilitando o contato dos pacientes para agendamentos
                    e dúvidas.
                  </p>
                </div>
                <div className="text-center mt-3 texto-poppins-sobre">
