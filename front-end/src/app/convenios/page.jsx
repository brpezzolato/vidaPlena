  ...
  return (
    <div className="paginaConvenios">
      ...
      <section className="introducao text-center">
        ...
        <p>
          A Clínica Vida Plena busca sempre oferecer o melhor atendimento para
          você. Por isso, firmamos parcerias com diversos convênios médicos,
          garantindo acesso fácil, seguro e de qualidade aos nossos serviços.
          Veja abaixo os convênios aceitos atualmente:
        </p>
      </section>
      ...
      <section className="gradeConvenios">
        ...
        <Link href="https://bradescosaudeconvenios.com.br/">
          <div className="convenio">
            <img src="/imgConvenios/bradescoSaude.png" alt="Bradesco Saúde" />
          </div>
        </Link>
      ...
      <div className="accordion accordion-flush" id="accordionFlushExample">
        ...
        <div className="accordion-item">
          ...
          >
            <div className="accordion-body">
              Depende do convênio e do tipo de atendimento. Consulte seu plano
        ...
        <div className="accordion-item">
          ...
          >
            <div className="accordion-body">
              Sim! Também atendemos particular com condições especiais. Fale com
              nossa equipe.
            </div>
          </div>
        </div>
      ...
      <section className="contatoConvenios">
        ...
        <p>Ficou com dúvidas ou quer confirmar o atendimento pelo seu plano?</p>
