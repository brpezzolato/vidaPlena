        ...
        <div className="container mb-4">
          <div className="topoNoticia mt-4 d-flex mb-4">
            <img
              ...
              className="img-fluid img-speak imageNoticia"
            />
            <div className="geralInfosNoticia">
              <img
                src="/imgNoticia/bannerImgNoticia.png"
                className="img-fluid bannerNoticia rounded-end"
              />
            </div>
          </div>
          ...
          <div className="meioNoticia d-flex flex-column flex-lg-row">
            <div className="noticiaEscritaMeio flex-grow-1 mb-4 mb-lg-0 me-lg-4">
              ...
              <h6 className="subtituloNoticia">{noticia.subtitulo}</h6>
              ...
              <div className="topNoticias p-4">
                {topNoticias.map((top, index) => (
                  <div className="elementosTopNoticia d-flex mb-4" key={top.id}>
                    ...
                    <Link
                      href={`/noticia/${top.id}`}
                      className="noticiaTop text-decoration-none text-dark"
                    >
                      {top.titulo.length > 75
                        ? top.titulo.slice(0, 75) + '...'
                        : top.titulo}
                    </Link>
                  </div>
                ))}
