    ...
    <div className="container-fluid">
      ...
      <div className="collapse d-md-none" id="mobileMenu">
        <div className="d-flex flex-column align-items-center px-3 gap-3 py-3 mobile-menu">
          <Link href="/adm" className="menu-link">
            Home
          </Link>
          <Link href="/adm/medicos" className="menu-link">
            Médicos
          </Link>
          <Link href="/adm/usuarios" className="menu-link">
            Pacientes
          </Link>
          <Link href="/adm/consultas" className="menu-link">
            Consultas
          </Link>
          <img
